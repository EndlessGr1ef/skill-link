...
- The acceptance criterion is the **actual rendered desktop geometry** users see on the real shell. Class-name presence alone is not sufficient evidence if the dialog still looks narrow at runtime.
